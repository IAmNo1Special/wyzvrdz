...
Usage:
    ...
    python generate_review.py <workspace-path> --previous-feedback <path>
...
def embed_file(path: Path) -> dict:  # noqa: PLR0911
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            ...
            feedback_path: Path to save feedback JSON.
            previous: Previous feedback data.
            benchmark_path: Optional path to benchmark data.
            *args: Additional args for BaseHTTPRequestHandler.
            **kwargs: Additional kwargs for BaseHTTPRequestHandler.
        """
...
def main() -> None:  # noqa: PLR0915
    """Main entry point for the review server."""
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "(shows old outputs and feedback)"
        ),
    )
    parser.add_argument(
        "--benchmark",
